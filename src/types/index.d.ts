...
import type { fetchPostDetail, getBJSolveDetail } from '../loader/post.loader';
...
export type BJSolveDetailType = NonNullable<Awaited<ReturnType<typeof getBJSolveDetail>>>